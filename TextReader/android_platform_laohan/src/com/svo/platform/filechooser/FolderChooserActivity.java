...
import com.svo.platform.filechooser.tree.BaseFileTreeNode;
import com.svo.platform.filechooser.tree.TreeAdapter;
import com.svo.platform.filechooser.tree.TreeNodeIconType;
...
public class FolderChooserActivity extends Activity {
	...
	@Override public void onCreate(Bundle savedInstanceState) {
		...
		FileChooserUtils.configureTitles(this, config.title, config.subtitle);
